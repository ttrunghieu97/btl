...
function getDetailPromo(sp) {
    switch (sp.promo.name) {
        case 'tragop':
            ...
            return `Khách hàng có thể mua trả góp sản phẩm với ` + span + `vô thời hạn kể từ khi mua hàng.`;
        ...
        case 'giareonline':
            ...
            return `Sản phẩm sẽ được giảm ` + span + `₫ khi mua hàng online bằng thẻ VISA hoặc thẻ đen hoặc momo`;

        default:
            var span = `<span style="font-weight: bold">100 xe SH 350i</span>`;
